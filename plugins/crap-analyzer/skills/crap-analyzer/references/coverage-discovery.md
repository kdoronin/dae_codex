...
**Always prefer the repo's own coverage script** when it exists — it's the maintainer's canonical command and is likely wired into CI. Per-ecosystem workflow entrypoints are in the sections below.
