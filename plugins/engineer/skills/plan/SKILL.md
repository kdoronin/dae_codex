---
name: plan
description: Use when a feature has ACs and specs and needs an architecture plan before implementation. Triggers — "engineer plugin -> plan skill", "plan this feature", "plan the implementation", "design the architecture".
---
