...
start of the workflow), run:
    ...
    ${PLUGIN_ROOT}/scripts/dae_progress.py <feature-dir>
...
At the start of the skill, create **one Codex plan item per workflow step**, all
...
when it ends. The Codex plan panel is the live position indicator.
