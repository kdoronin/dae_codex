...
For install workflow entrypoints, configuration, and CLI reference, see
`references/frameworks.md`.
...
- **Custom-tool path** — the Hashing/Selection module hashes each function and
  ...
  changed. See `${PLUGIN_ROOT}/references/differential-mutation.md`.
...
Before Step 1, create one Codex plan item per step of this workflow (Steps 1–6),
